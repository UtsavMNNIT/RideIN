...
import com.rideflow.driver.infrastructure.persistence.jpa.repository.ProcessedEventJpaRepository;
...
/** JPA adapter for {@link ProcessedEventStore} over {@code driver.processed_events}. */
@Repository
