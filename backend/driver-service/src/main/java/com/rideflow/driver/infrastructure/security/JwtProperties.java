 ...
 *
 * @param secret         HMAC signing secret; override per environment.
 * @param issuer         the {@code iss} claim.
 * @param accessTokenTtl token lifetime; ISO-8601 duration (e.g. {@code PT12H}).
 */
...
public record JwtProperties(String secret, String issuer, Duration accessTokenTtl) {
    ...
    public JwtProperties {
        if (issuer == null || issuer.isBlank()) {
            issuer = "rideflow-driver-service";
        }
