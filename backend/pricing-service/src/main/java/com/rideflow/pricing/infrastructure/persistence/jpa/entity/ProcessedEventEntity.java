...
/**
 * JPA mapping for {@code pricing.processed_events} — consumer-side idempotency.
 * Composite key {@code (event_id, consumer_group)}: a redelivery to the same
 * group collides on the PK.
 */
@Entity
@Table(name = "processed_events", schema = "pricing")
