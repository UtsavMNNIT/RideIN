...
/**
 * Consumer-side Kafka wiring for the {@code rider.RideRequested} listener.
 *
 ...
 *   <li>Everything else (DB blips, broker hiccups) — transient → retried with
 *       backoff; DLQ only after the budget. Fail closed: a ride is retried,
 *       never silently left unpriced.</li>
 * </ul>
 */
@Configuration
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaOperations<Object, Object> dlqKafkaTemplate) {
        ...
        backOff.setMaxElapsedTime(20_000L);   // ~20s transient-fault tolerance before DLQ
