package com.rideflow.trip.infrastructure.messaging.kafka.config;
...
/**
 * Consumer-side Kafka wiring for the {@code matching.ride-assigned} listener.
 * Bad data ({@link DeserializationException}/{@link IllegalArgumentException}) →
