...
import com.rideflow.trip.infrastructure.persistence.jpa.repository.ProcessedEventJpaRepository;
...
/** JPA adapter for {@link ProcessedEventStore} over {@code trip.processed_events}. */
@Repository
