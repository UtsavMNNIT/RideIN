...
: "${PAYMENT_DB_PASSWORD:?must be set in compose env}"
...
create_role payment_user  "${PAYMENT_DB_PASSWORD}"  payment

echo "[rideflow-init] done. schemas: rider, driver, matching, pricing, trip, payment"
